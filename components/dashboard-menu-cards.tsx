...
import { Users, FileText, TrendingUp, Settings, BarChart3, UserCheck, Building2, Calculator, ClipboardList, Eye } from 'lucide-react'
        ...
        >
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <div className={`bg-gradient-to-r ${item.color} p-3 rounded-xl text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                <item.icon className="h-6 w-6" />
              </div>
              <Badge className={`${item.badgeColor} font-medium`}>
                {item.badge}
              </Badge>
            </div>
