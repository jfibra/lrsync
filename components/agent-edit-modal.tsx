...
export function AgentEditModal({ open, agent, onClose, onSave }: AgentEditModalProps) {
    ...
    useEffect(() => {
        ...
        // Normalize dropdown rate fields to remove trailing zeros and decimals
        const normalizeRate = (val: any) =>
            val === null || val === undefined ? "0" : String(Number(val))
    ...
    const sanitizePayload = (data: any) => {
        const numericFields = [
            "comm", "net_of_vat", "agent_amount", "agent_vat", "agent_ewt", "agent_ewt_rate", "agent_net_comm",
            "um_rate", "um_developers_rate", "um_amount", "um_vat", "um_ewt", "um_ewt_rate", "um_net_comm",
            "tl_rate", "tl_developers_rate", "tl_amount", "tl_vat", "tl_ewt", "tl_ewt_rate", "tl_net_comm",
            "agents_rate", "developers_rate"
        ];
