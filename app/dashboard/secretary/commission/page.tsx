...
export default function SecretaryCommissionPage() {
  ...
  const fetchSales = async () => {
    try {
      ...
      // Filter by secretary's assigned area only
                    ...
                    {loading ? (
                      ...
                      <TableRow>
                        <TableCell colSpan={11} className="text-center py-12">
                          ...
                          <p className="text-gray-500">
                            No sales records found for your assigned area: {profile?.assigned_area}
                          </p>
                        </TableCell>
                      </TableRow>
                    ) : (
