...
export default function AdminSalesPage() {
  ...
  const exportToExcel = () => {
    ...
    // Create summary data
    const summaryData = [
      [`SALES MANAGEMENT REPORT - ${profile?.assigned_area || "Unknown Area"} (Invoice Sales Only)`],
      [
        "Generated on:",
    ...
    const filename = `Invoice_Sales_Report_${profile?.assigned_area?.replace(/\s+/g, "_")}_${new Date().toISOString().split("T")[0]}.xlsx`
